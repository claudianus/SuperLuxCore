...
typedef enum {
	...
	DEVICE_TYPE_METAL_GPU = 1 << 6,
	DEVICE_TYPE_VULKAN_GPU = 1 << 7,
	...
	DEVICE_TYPE_METAL_ALL = DEVICE_TYPE_METAL_GPU,
	DEVICE_TYPE_VULKAN_ALL = DEVICE_TYPE_VULKAN_GPU,
	...
	DEVICE_TYPE_ALL_HARDWARE = DEVICE_TYPE_OPENCL_ALL | DEVICE_TYPE_CUDA_ALL |
		DEVICE_TYPE_METAL_ALL | DEVICE_TYPE_VULKAN_ALL,
