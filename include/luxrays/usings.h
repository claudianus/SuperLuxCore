...
DECLARE_SUBTYPES(MetalDevice);
DECLARE_SUBTYPES(MetalDeviceKernel);
DECLARE_SUBTYPES(MetalDeviceProgram);
DECLARE_SUBTYPES(MetalDeviceDescription);
DECLARE_SUBTYPES(MetalIntersectionDevice);
...
DECLARE_SUBTYPES(VulkanDevice);
DECLARE_SUBTYPES(VulkanDeviceKernel);
DECLARE_SUBTYPES(VulkanDeviceProgram);
DECLARE_SUBTYPES(VulkanDeviceDescription);
DECLARE_SUBTYPES(VulkanIntersectionDevice);
DECLARE_SUBTYPES(UV);
