...
extern std::string KernelSource_sampler_pmj02_funcs;
...
extern std::string KernelSource_materialdefs_funcs_diffraction;
...
extern std::string KernelSource_hair_huang_lut;
extern std::string KernelSource_materialdefs_funcs_hair;
