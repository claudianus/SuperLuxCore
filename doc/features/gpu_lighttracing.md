...
- `LightSource::Emit` — ✅ `45caf3459` ported `*_Emit` for the light
  types; `a7c3ae282` extended coverage to sphere/map-sphere/projection/
...
- Camera inverse projection — ✅ `45caf3459`: `GetSamplePosition`/
