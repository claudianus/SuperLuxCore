...
| GPU light tracing + LMNEE/MGE | [gpu_lighttracing.md](gpu_lighttracing.md) | `2fce509e1` tasks, `09081cc54` Emit, `41a9e03f5` camera, `e76d03298` state machine, `8f90fe099` splat, `23c56e61d` LMNEE, `7dfecaaa3` MGE, `1f7c193fa` lt-only natives | `dev-tools/e23_*` LT parity; `e45_lighttracing_only_test.py`; cornell | OCL/Metal |
...
| GPU vertex connection (M6) | [gpu_vertexconnection.md](gpu_vertexconnection.md) | `4badd28c3`, MIS lift gate `189837864` | `dev-tools/e38_vc_smoke.py`, `e44_vc_shadowtransparency_test.py` | OCL/Metal |
