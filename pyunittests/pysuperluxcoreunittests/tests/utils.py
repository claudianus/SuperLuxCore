...
class LuxCoreTest(unittest.TestCase):
	customConfigProps = pysuperluxcore.Properties()

def LuxCoreHasOpenCL():
	return not pysuperluxcore.GetPlatformDesc().Get("compile.LUXRAYS_DISABLE_OPENCL").GetBool()
...
engineProperties = {
	"PATHCPU" : pysuperluxcore.Properties().SetFromString(
		"""
		film.width = 150
		film.height = 100
		batch.haltspp = 0
		...
		"""),
	"BIDIRCPU" : pysuperluxcore.Properties().SetFromString(
		"""
		film.width = 150
		film.height = 100
		batch.haltspp = 0
		...
		batch.haltthreshold = 0.075
		"""),
	"TILEPATHCPU" : pysuperluxcore.Properties().SetFromString(
		"""
		film.width = 150
		film.height = 100
		batch.haltspp = 0
		...
		"""),
	"PATHOCL" : pysuperluxcore.Properties().SetFromString(
		"""
		film.width = 150
		film.height = 100
		batch.haltspp = 0
		...
		batch.haltthreshold = 0.075
		"""),
	"TILEPATHOCL" : pysuperluxcore.Properties().SetFromString(
		"""
		film.width = 150
		film.height = 100
		batch.haltspp = 0
