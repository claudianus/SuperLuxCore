...
class TestProperties(unittest.TestCase):
	def test_Properties_SetPrefix(self):
		...
		props.Set(pysuperluxcore.Property("test1.prop1", "aa"))
		
		props2 = pysuperluxcore.Properties()
		props2.Set(pysuperluxcore.Property("aa.prop1", "bb"))
		props2.Set(pysuperluxcore.Property("bb.prop2", "cc"))
	...
	def test_Properties_GetAllNames(self):
		props = pysuperluxcore.Properties()
		props.Set(pysuperluxcore.Property("test1.prop1", "aa"))
		props.Set(pysuperluxcore.Property("test1.prop2", "bb"))
		props.Set(pysuperluxcore.Property("test2.prop1", "cc"))
	...
	def test_Properties_GetAllUniqueSubNames(self):
		props = pysuperluxcore.Properties()
		props.Set(pysuperluxcore.Property("test1.prop1.aa", "aa"))
		props.Set(pysuperluxcore.Property("test1.prop1.bb", "bb"))
		props.Set(pysuperluxcore.Property("test1.prop1.prop2.aa", "aa"))
		props.Set(pysuperluxcore.Property("test1.prop1.prop2.bb", "bb"))
		props.Set(pysuperluxcore.Property("test1.prop2.aa", "aa"))
		props.Set(pysuperluxcore.Property("test2.prop1.aa", "aa"))
		props.Set(pysuperluxcore.Property("test2.prop1.bb", "bb"))
		props.Set(pysuperluxcore.Property("test2.prop2", "aa"))
		props.Set(pysuperluxcore.Property("test3.prop1.aa", "aa"))
	...
	def test_Properties_HaveNamesRE(self):
		...
		props.Set(pysuperluxcore.Property("test1.prop1", "aa"))
		props.Set(pysuperluxcore.Property("test1.prop2", "bb"))
		props.Set(pysuperluxcore.Property("test2.prop1.aa", "cc"))
	...
	def test_Properties_SpaceInName(self):
		props = pysuperluxcore.Properties()
		props.Set(pysuperluxcore.Property("aa.b b.cc", "123"))
