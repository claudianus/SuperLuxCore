...
from pysuperluxcoreunittests.tests.render import *
...
def StandardSceneTest(cls, params, cfgName, testName, callerAdditionalProps = pysuperluxcore.Properties()):
	engineType = params[0]
	...
	props.Set(pysuperluxcore.Property("renderengine.type", engineType))
	props.Set(pysuperluxcore.Property("sampler.type", samplerType))

	# Set the file name resolver paths
	pysuperluxcore.ClearFileNameResolverPaths()
	pysuperluxcore.AddFileNameResolverPath(cfgDir)
