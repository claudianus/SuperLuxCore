...
def TestTwoGlassesLuxCoreTestScene(cls, params):
	...
	additionalProps = pysuperluxcore.Properties()
	additionalProps.Set(pysuperluxcore.Property("film.width", filmWidth))
	additionalProps.Set(pysuperluxcore.Property("film.height", filmHeight))
	additionalProps.Set(pysuperluxcore.Property("periodicsave.film.outputs.period", 0))
