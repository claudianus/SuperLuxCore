...
from .._renderfarm import DEFAULT_PORT
from .._renderfarm.node import RenderFarmNode
...
def LuxCoreNetNode(argv):
    parser = argparse.ArgumentParser(description="PySuperLuxCoreNetNode")
    parser.add_argument(
        "-b",
        "--broadcast-address",
        metavar="BROADCAST_ADDRESS",
        default="<broadcast>",
