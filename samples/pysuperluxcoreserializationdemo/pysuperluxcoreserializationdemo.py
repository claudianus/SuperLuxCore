...
def SaveFilm():
	...
	props = pysuperluxcore.Properties("scenes/simple/simple.cfg")
	#props = pysuperluxcore.Properties("scenes/luxball/luxball-hdr.cfg")
	# To test large films
	#props.Set(pysuperluxcore.Property("film.width", 2048))
	#props.Set(pysuperluxcore.Property("film.height", 2048))
...
def LoadFilm():
	print("Film loading...")
	t1 = Clock()
	film = pysuperluxcore.Film("simple.flm")
	t2 = Clock()
	...
	film.SaveOutput("simple.png", pysuperluxcore.FilmOutputType.RGB_IMAGEPIPELINE, pysuperluxcore.Properties())
	...
	for i in range(0, 20):
		...
		film.SaveOutput("simple" + str(i) + ".png", pysuperluxcore.FilmOutputType.RGB_IMAGEPIPELINE, pysuperluxcore.Properties())
